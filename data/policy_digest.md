...
|---|----------------------|
| 1 | Specific CPS course(s) being requested, identified by course code and name (e.g., ITC 1000 – Computer Applications, ALY 6010 – Correlation and Regression Analysis) |
| 2 | Number of credits requested per course (must be specified per course, not just a total) |
| 3 | Program area the course belongs to: ALY (Analytics / Data Science), ITC (Information Technology), or Other / Not sure |
 
> If the student is unsure of the exact course code, they should describe the subject area and an advisor will help identify the match.
...
## 5. Governing Standards — CAEL Ten Standards of Assessment
